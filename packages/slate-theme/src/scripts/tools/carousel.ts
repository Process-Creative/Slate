...
import { CLASS_ACTIVE, CLASS_INITIALIZED } from './classes';
import { eventAdd } from './events';

export type CarouselSliderOptions = {
...
export const carouselInit = (p:CarouselInitParams):Carousel|null => {
  ...
  return {
    keenSlider, slides, keenRefresh, state, container,
